function App() {
  ...
  const apiKey = "AIzaSyA2JysXqD3UGE95n3depWcbovu80jI8vJg";
  ...
  const generateStory = async () => {
    ...
    if (!apiKey || apiKey === "AIzaSyA2JysXqD3UGE95n3depWcbovu80jI8vJg") {
      setError("AIzaSyA2JysXqD3UGE95n3depWcbovu80jI8vJg");
      setIsLoading(false);
      return;
    }
  ...
  const generateRandomPrompt = async () => {
    ...
    if (!apiKey || apiKey === "YOUR_GEMINI_API_KEY_HERE") {
      setError("API Key is missing. Please replace 'YOUR_GEMINI_API_KEY_HERE' in App.js with your actual key.");
      setIsLoading(false);
      return;
    }
